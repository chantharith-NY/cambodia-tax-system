        ...
        <div class="bg-white shadow-xl rounded-2xl p-8">
            ...
            <div class="mb-8">
                ...
                <h1 class="text-3xl font-bold text-gray-900">
                    Create Salary Tax Bracket
                </h1>

                <p class="text-gray-500 mt-1">
                    Configure salary tax rates and salary ranges for payroll calculations.
                </p>
            ...
            <form
                action="{{ route('admin.salary-tax-brackets.store') }}"
                method="POST">
